defmodule AgregatWeb.UserAuthTest do
  use AgregatWeb.ConnCase, async: true

  alias Agregat.Users
  alias AgregatWeb.UserAuth
  import Agregat.UsersFixtures

  @remember_me_cookie "_agregat_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AgregatWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AgregatWeb.Endpoint.subscribe(live_socket_id)
