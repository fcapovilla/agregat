...
config :agregat, AgregatWeb.Endpoint,
  ...
  live_view: [signing_salt: "nYOTAEK8"]
...
config :agregat, Agregat.Mailer, adapter: Swoosh.Adapters.Local
...
config :dart_sass,
  version: "1.43.4",
  default: [
    args: ~w(--load-path=./vendor css/app.scss ../priv/static/assets/app.css),
    cd: Path.expand("../assets", __DIR__)
  ]
